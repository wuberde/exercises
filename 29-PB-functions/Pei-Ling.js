...
const dogAge = (a) => a * 7;
console.log(
    `Task 7: According to Guinness World Records, the dog named Bluey lived 29 years and 5 months, which converted to the human age is ${Math.round(dogAge(29.416666667))} years old.`
);
