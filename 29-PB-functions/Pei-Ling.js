...
console.log(`Task 2:`, sumOfCubes(1, 5, 9));
...
console.log(`Task 5: How many times does the letter o appear in the longest English word "pneumonoultramicroscopicsilicovolcanoconiosis"?`, countOccurrences("pneumonoultramicroscopicsilicovolcanoconiosis", "o"));
...
console.log(`Task 7: According to Guinness World Records, the dog named Bluey lived 29 years, which converted to the human age of`, (Math.round(dogAge(29.416666667))), `years old.`);
